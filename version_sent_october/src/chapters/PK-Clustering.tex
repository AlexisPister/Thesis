...
PK-Clustering is an interactive clustering system. A review by Bae et al~\cite{baeInteractiveClusteringComprehensive2020} shares our concerns:
...
I asked one of our historian colleagues for her prior knowledge on her network about the trades of Marie Boucher~\cite{dufournaudAnalyseRéseauxAide2017},  %\autoref{fig:PK-MBstaticFamily} shows that the Marie Boucher dataset is
