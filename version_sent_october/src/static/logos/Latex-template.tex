...
\begin{document}
	...
	\begin{titlepage}
		...
		\tikz[remember picture,overlay] \node[opacity=1,inner sep=0pt] at (-13mm,-135mm){\includegraphics{Frame-ups}};
		...
		\flushright \includegraphics[scale=1]{logo2}
...
\begin{center} 
	\includegraphics[scale=0.6]{Charte_graphique_ups}
\end{center}
...
\noindent \textbf{\color{Prune}$\rightarrow$} n\degree564 : physique en Île-de-France (PIF)\\    \includegraphics[scale=.7]{logo_usp_PIF}\\
...
\noindent \textbf{\color{Prune}$\rightarrow$} n\degree569 : innovation thérapeutique : du fondamental à l'appliqué (ITFA)\\    \includegraphics[scale=.7]{logo_usp_ITFA}\\
