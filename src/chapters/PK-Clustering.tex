...
Clustering results can thus be reviewed in a more transparent manner (according the \traceability principle), revealing the decisions taken. In contrast, traditional reporting in the Humanities rarely questions or discusses how choices were made and merely mentions the algorithm and parameters used.
...
I asked one of our historian colleague her prior knowledge on her network about the trades of Marie Boucher~\cite{Dufournaud17},  %\autoref{fig:PK-MBstaticFamily} shows that the Marie Boucher dataset is
...
In the second cases study I take the role of Alice, a VAST Steering Committee (SC) member, who participates in a SC meeting to validate the Program Committee proposed by the VAST paper chairs for the next conference.
...
In order to improve the computational scalability, progressive techniques can help to deal with larger sizes~\cite{Progressive}.
