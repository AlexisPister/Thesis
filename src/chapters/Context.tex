...
The use of network measures lets sociologists explain social phenomena through the formal description of real observations of relationships modeled as networks. \rev{I describe commonly used methods and measures in the following subsection.}
...
More generally, sociologists aim to identify recurring patterns of sociability between actors and link them to other behaviors, measures, or qualitative knowledge.
...
Moreover, more and more social scientists are following exploratory approaches \rev{using visualization tools with a focus on interaction, allowing them to unfold the structure of their data and generate new interesting hypotheses.}
...
\rev{
I propose a qualitative classification of all those tools in \ref{tab:SNV} which ranks them according to their visualization, \sna measures and modes, clustering, filtering, and interaction capabilities.
