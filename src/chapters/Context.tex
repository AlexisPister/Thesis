...
Guildi and Aritage even criticized the decrease of interest of historians in working in archives \cite{guldiHistoryManifesto2014}.
...
Moreover, more and more social scientists are now following exploratory approaches using Visual Analytics (VA) tools, to describe more in-depth their data and generate new interesting hypotheses, using interaction and exploration capabilities.
