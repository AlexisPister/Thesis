...
In 1993, Wilkinson extended Bertin's work and developed the \textit{Grammar of Graphics} \cite{wilkinsonGrammarGraphics1993} as a way to describe the deep structure unifying every possible graphic, thus allowing to characterize and create graphics using common terms and rules.
