...
This approach has first be formalized in sociology under the term Social Network Analysis (SNA) and is now widely used in anthropology, geography, and history.
...
This thesis consider the whole workflow of social historians to better support it with visual analytics.
...
Most \snv tools are agnostic to the process of social historians leading to a polished network, even though it has an high impact of the network model and structure. Using visualization only at the end of the process often reveals potential errors and inconsistencies\cite{alkadi2022}.
