...
Some systems hide the scripting language, such as \project{GRAPHITE}~\cite{chauGRAPHITEVisualQuery2008}, \project{Intuinet}\footnote{See \url{https://intuinet.fr}}, and \project{VERTIGo}~\cite{cuencaVERTIGoVisualPlatform2021} that allow specifying a graph query as a node-link diagram that the user creates interactively.
...
\name is made of three components: a visual web interface, a python server, and a Neo4j\cite{neo4j} graph database instance.
