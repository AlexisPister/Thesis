...
In the previous chapter \autoref{ch:hsna-process-and-network-modeling}, I showed that \modelplural allow to model well historical documents, with \traceability, \reality, and \simplicity properties.
...
This was a demand of our collaborators, who can share the results of their queries easily or use them in another software or tool, according to the \traceability principle.
...
With this data model, \name let historians explore a concrete representation of their annotated documents (\ie the model expresses the \emph{reality} of the documents, without the use of projections or distortions) with \traceability to the original sources and \simplicity.
