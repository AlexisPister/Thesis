...
We describe in this chapter the HSNA workflow followed by social historians, to shed light on their process and potential needs for VA tools.
...
However, data collection, cleaning, and transformation steps are crucial and can introduce lots of bias and distortion on the final data if not done correctly.
