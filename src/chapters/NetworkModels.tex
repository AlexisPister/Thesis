...
Annotation \jdf{add "often called \emph{encoding}",} is the process of finding and extracting useful information from the documents concerning the persons, their social ties, and any useful information for the historian.
