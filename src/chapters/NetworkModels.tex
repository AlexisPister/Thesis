...
To study relational social structures where individuals influence each other such as families, companies, and institutions, historians can rely on \hsma by modeling the social relationships between a set of entities---usually individuals---into a network.
...
This information  allowed them to conclude that the inscription ``expelled'' in pencil was probably added during world war II by germans to denote exported Jews in the extermination camps.
