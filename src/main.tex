...
% Preamble
\documentclass[12pt,a4paper, twoside, headings=small]{book}
\usepackage{color}
...
%    \end{titlepage}
    \begin{titlepage}
        ...
        \begin{picture}(0,0)
            \put(-152,-743){\rotatebox{90}{\Large \textsc{THESE DE DOCTORAT}}} \\
            \put(-120,-743){\rotatebox{90}{NNT : 2022UPASG081}}
        \end{picture}
...
%*****************************************************
    ...
    \titleformat{\chapter}[hang]{\bfseries\Huge\color{Prune}}{\thechapter\quad}{.1ex}{}{}%{\vspace{0.1ex}}[\vspace{1ex}]
%    \titlespacing{\chapter}{0pc}{0ex}{0.5pc} % Original
...
\fancyhead[RE]{\fontsize{10}{12}\selectfont\nouppercase\rightmark}
